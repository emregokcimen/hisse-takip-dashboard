...
const FIB_LEVEL_RATIOS = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1, 1.272, 1.414, 1.618, 2, 2.618];
...
function computeDynamicFibPlan(points = [], currentPrice, manualTarget = null) {
